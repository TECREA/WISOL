...
int main(int argc,  char *argv[]){     
    ...
    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_INIT_OK,      != , WSSFM1XRX_Init( &Driver_WSS, ResetControl, Reset2Control, OutputFunction, WSSFM1XRX_RCZ4, DownlinkCallback, GetTickCountMs, InputBuffer, sizeof(InputBuffer), 4), 1E4, "");
    ...
    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_OK_RESPONSE , != , WSSFM1XRX_SaveParameters( &Driver_WSS, WSSFM1XRX_Wait_NonBlock), 10, "OK\r" );
    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_CHANN_OK ,    != , WSSFM1XRX_CheckChannels( &Driver_WSS, WSSFM1XRX_Wait_NonBlock), 10, "1,6\r" );
    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_OK_RESPONSE , != , WSSFM1XRX_ResetChannels( &Driver_WSS, WSSFM1XRX_Wait_NonBlock), 10, "OK\r" );

    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_OK_RESPONSE , != , WSSFM1XRX_SendMessage( &Driver_WSS, WSSFM1XRX_Wait_NonBlock, Payload, 12, SF_FALSE), 20, "OK\r" );
    TEST_WSSFM_WAITUNTIL(  WSSFM1XRX_OK_RESPONSE , != , WSSFM1XRX_SendMessage( &Driver_WSS, WSSFM1XRX_Wait_NonBlock, Payload, 12, SF_TRUE), 20, "OK\r" );
